<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Web_SFH.Users.Default" %>
...
<head runat="server">
    ...
    <link href="../css/httGirdView.css?v=2021072201" rel="stylesheet" />  
    <link href="../css/text.css?v=2021072201" rel="stylesheet" />    
    <link href="../CSS/Toolbar.css?v=2021072201" rel="stylesheet" />
    <link href="../CSS/modify.css?v=2021072201" rel="stylesheet" />
    <script src="../Scripts/jquery-3.6.0.min.js"></script>
    <script src="../js/lib.js?v=2021072201"></script>
    <script src="../js/GridView.js?v=2021072401"></script>
    <script src="../js/FieldKeys.js?v=2021072201"></script>
    <script src="../js/User.js?v=2021072201"></script>
    <script src="../js/StateCity.js?v=2021072201"></script>
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var Grid = {
                url:'../Handlers/Handler_GetUsers.ashx',
                width: 875,
                ...
                columns: [
                    ...
                    {
                        value: 'PersonalInfo.Person.FullName',
                        field: 'Fullname',
                        title: 'FULL NAME',                       
                        width: 163,
                        widthPlus: 0,
                    ...
                    {
                        value: 'PersonalInfo.Contact.MobilePhone',
                        field: 'MobilePhone',
                        title: 'MOBILE PHONE',
                        width: 141,
                        widthPlus: 0,
                    ...
                    
                    {
                        ...
                        filterable: false,
                        hidden: true,
                        template: "<p id='vie#User_Id#'  class='detail'></p>"
            ...
            //User
            var user = new User();
            user.stateCities = new StateCity().sateCities;  
            user.Init('#modify', gridView);
